function Validation(values) {
     ...
     (values.first_name !== undefined && values.name === '') ? Errors.message = 'First Name is required' :
     (values.last_name !== undefined && values.username === '') ? Errors.message = 'Last Name is required' :
     ...
     (values.confirm_password !== values.password) ? Errors.message = 'Passwords do not match' : null;
     ...
     (values.confirm_password !== values.password) ? Errors.confirm_password = (values.confirm_password !== values.password) ? true : false : null;
