     ...
     <>
          <div className='home'>
               ...
               <div className='knowledge-section'>
                    ...
                    <div className='right'>
                         <p className='right-top'>News －O－ Industry insights －O－ Latest in technology</p>
                         ...
                         <div className="section">
                              ...
                              <p className="undertext">Go through this checklist to identify, contain, and prevent crucial</p>
                              <a className="link" articlename="How to Evaluate Machine Learning Algorithms" href="/india/knowledge-centre/ML-algorithms">Read More</a>
                         </div>
                         <div className="section">
                              <picture>
